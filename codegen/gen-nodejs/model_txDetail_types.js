...
var TxDetailResponse = module.exports.TxDetailResponse = function(args) {
  this.txHash = null;
  this.time = null;
  this.height = null;
  this.sender = null;
  ...
  if (args) {
    ...
    if (args.fee !== undefined && args.fee !== null) {
      this.fee = new ttypes.FeeUsed(args.fee);
    }
...
var FeeUsed = module.exports.FeeUsed = function(args) {
  this.denom = null;
  this.cost = null;
  if (args) {
