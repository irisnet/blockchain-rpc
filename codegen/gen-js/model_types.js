...
GasUsed.prototype.read = function (input) {
    ...
    while (true) {
        ...
        switch (fid) {
            case 1:
                if (ftype == Thrift.Type.DOUBLE) {
                    this.minGasUsed = input.readDouble().value;
                } else {
                    input.skip(ftype);
                }
                break;
            case 2:
                if (ftype == Thrift.Type.DOUBLE) {
                    this.maxGasUsed = input.readDouble().value;
                } else {
                    input.skip(ftype);
                }
                break;
            case 3:
                if (ftype == Thrift.Type.DOUBLE) {
                    this.avgGasUsed = input.readDouble().value;
                } else {
                    input.skip(ftype);
                }
                break;
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.STRUCT) {
        ...
        case 13:
            if (ftype == Thrift.Type.DOUBLE) {
                this.gas = input.readDouble().value;
            } else {
                input.skip(ftype);
            }
            break;
