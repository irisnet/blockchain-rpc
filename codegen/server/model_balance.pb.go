...
func (*BalanceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_model_balance_dba89d7c77f60496, []int{0}
}
...
func (*BalanceResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_model_balance_dba89d7c77f60496, []int{1}
}
...
func (m *BalanceResponse) GetCoins() []*Coin {
	if m != nil {
		return m.Coins
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*BalanceResponse)(nil), "model.balance.BalanceResponse")
}

func init() { proto.RegisterFile("model_balance.proto", fileDescriptor_model_balance_dba89d7c77f60496) }

var fileDescriptor_model_balance_dba89d7c77f60496 = []byte{
	...
	0x9c, 0x41, 0x30, 0xae, 0x92, 0x35, 0x17, 0x3f, 0x5c, 0x6d, 0x71, 0x41, 0x7e, 0x5e, 0x71, 0xaa,
	0x90, 0x06, 0x17, 0x6b, 0x72, 0x7e, 0x66, 0x1e, 0x48, 0x29, 0xb3, 0x06, 0xb7, 0x91, 0x90, 0x1e,
	0xc4, 0x46, 0xa8, 0x15, 0xce, 0xf9, 0x99, 0x79, 0x41, 0x10, 0x05, 0x4e, 0xec, 0x51, 0xac, 0x60,
	0xb9, 0x00, 0x86, 0x24, 0x36, 0xb0, 0xd5, 0xc6, 0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0xb8, 0x95,
	0x3e, 0xcb, 0xb4, 0x00, 0x00, 0x00,
}
