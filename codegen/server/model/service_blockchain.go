...
type BlockChainService interface {
  ...
  // Parameters:
  //  - Req
  GetTxList(ctx context.Context, req *TxListRequest) (r *TxListResponse, err error)
  // Parameters:
  //  - Req
  GetTxDetail(ctx context.Context, req *TxDetailRequest) (r *TxDetailResponse, err error)
}
...
func (p *BlockChainServiceClient) BuildTx(ctx context.Context, req *BuildTxRequest) (r *BuildTxResponse, err error) {
  var _args0 BlockChainServiceBuildTxArgs
  _args0.Req = req
  var _result1 BlockChainServiceBuildTxResult
  if err = p.c.Call(ctx, "BuildTx", &_args0, &_result1); err != nil {
    return
  }
  switch {
  case _result1.E!= nil:
...
func (p *BlockChainServiceClient) PostTx(ctx context.Context, req *PostTxRequest) (r *PostTxResponse, err error) {
  var _args2 BlockChainServicePostTxArgs
  _args2.Req = req
  var _result3 BlockChainServicePostTxResult
  if err = p.c.Call(ctx, "PostTx", &_args2, &_result3); err != nil {
    return
  }
  switch {
  case _result3.E!= nil:
...
func (p *BlockChainServiceClient) GetSequence(ctx context.Context, req *SequenceRequest) (r *SequenceResponse, err error) {
  var _args4 BlockChainServiceGetSequenceArgs
  _args4.Req = req
  var _result5 BlockChainServiceGetSequenceResult
  if err = p.c.Call(ctx, "GetSequence", &_args4, &_result5); err != nil {
    return
  }
  switch {
  case _result5.E!= nil:
...
// Parameters:
//  - Req
func (p *BlockChainServiceClient) GetTxList(ctx context.Context, req *TxListRequest) (r *TxListResponse, err error) {
...
// Parameters:
//  - Req
func (p *BlockChainServiceClient) GetTxDetail(ctx context.Context, req *TxDetailRequest) (r *TxDetailResponse, err error) {
...
type BlockChainServiceGetTxListResult struct {
  Success *TxListResponse `thrift:"success,0" db:"success" json:"success,omitempty"`
  E *Exception `thrift:"e,1" db:"e" json:"e,omitempty"`
}
...
var BlockChainServiceGetTxListResult_Success_DEFAULT *TxListResponse
func (p *BlockChainServiceGetTxListResult) GetSuccess() *TxListResponse {
  if !p.IsSetSuccess() {
    return BlockChainServiceGetTxListResult_Success_DEFAULT
  }
return p.Success
}
...
type BlockChainServiceGetTxDetailResult struct {
  Success *TxDetailResponse `thrift:"success,0" db:"success" json:"success,omitempty"`
  E *Exception `thrift:"e,1" db:"e" json:"e,omitempty"`
}
...
var BlockChainServiceGetTxDetailResult_Success_DEFAULT *TxDetailResponse
func (p *BlockChainServiceGetTxDetailResult) GetSuccess() *TxDetailResponse {
  if !p.IsSetSuccess() {
